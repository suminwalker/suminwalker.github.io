...
Currently, she's building a video intelligence platform that helps creators brainstorm, edit, and generate content using computer vision and deep learning, complete with geofencing, real-time analytics, and social automation. In parallel, she's completing the development of a stealth AI + geolocation mobile and desktop app that uses Edge AI and real-time policy detection to alert professionals to regulatory risks as they move—merging AI ethics, compliance innovation, and mobile UX design into one seamless experience.`,
...
By combining thoughtful UI/UX design with AI capabilities and location-aware features, I create experiences that anticipate user needs. Every MVP I build balances beautiful design with solid architecture—starting lean but ready to scale.`,
  ...
  socialLinks: {
    ...
    github: 'https://github.com/suminwalker'
  },
